...
namespace abb {
	namespace egm {
		...
		public:
			...
			enum : int {
				kEgmSignalsFieldNumber = 1,
			};
			// repeated double EgmSignals = 1;
			int egmsignals_size() const;
		private:
			int _internal_egmsignals_size() const;
		public:
			void clear_egmsignals();
		private:
			double _internal_egmsignals(int index) const;
			const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
				_internal_egmsignals() const;
			void _internal_add_egmsignals(double value);
			::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
				_internal_mutable_egmsignals();
		public:
			double egmsignals(int index) const;
			void set_egmsignals(int index, double value);
			void add_egmsignals(double value);
			const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
				egmsignals() const;
			::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
				mutable_egmsignals();
		...
		private:
			...
			typedef void DestructorSkippable_;
			struct Impl_ {
				::PROTOBUF_NAMESPACE_ID::RepeatedField< double > egmsignals_;
				mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
			};
			union { Impl_ _impl_; };
			friend struct ::TableStruct_egm_2eproto;
...
// optional uint32 seqno = 1;
		...
		// repeated double EgmSignals = 1;
		inline int EgmTestSignals::_internal_egmsignals_size() const {
			return _impl_.egmsignals_.size();
		}
		inline int EgmTestSignals::egmsignals_size() const {
			return _internal_egmsignals_size();
		}
		inline void EgmTestSignals::clear_egmsignals() {
			_impl_.egmsignals_.Clear();
		}
		inline double EgmTestSignals::_internal_egmsignals(int index) const {
			return _impl_.egmsignals_.Get(index);
		}
		inline double EgmTestSignals::egmsignals(int index) const {
			// @@protoc_insertion_point(field_get:abb.egm.EgmTestSignals.EgmSignals)
			return _internal_egmsignals(index);
		}
		inline void EgmTestSignals::set_egmsignals(int index, double value) {
			_impl_.egmsignals_.Set(index, value);
			// @@protoc_insertion_point(field_set:abb.egm.EgmTestSignals.EgmSignals)
		}
		inline void EgmTestSignals::_internal_add_egmsignals(double value) {
			_impl_.egmsignals_.Add(value);
		}
		inline void EgmTestSignals::add_egmsignals(double value) {
			_internal_add_egmsignals(value);
			// @@protoc_insertion_point(field_add:abb.egm.EgmTestSignals.EgmSignals)
		}
		inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
			EgmTestSignals::_internal_egmsignals() const {
			return _impl_.egmsignals_;
		}
		inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
			EgmTestSignals::egmsignals() const {
			// @@protoc_insertion_point(field_list:abb.egm.EgmTestSignals.EgmSignals)
			return _internal_egmsignals();
		}
		inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
			EgmTestSignals::_internal_mutable_egmsignals() {
			return &_impl_.egmsignals_;
		}
		inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
			EgmTestSignals::mutable_egmsignals() {
			// @@protoc_insertion_point(field_mutable_list:abb.egm.EgmTestSignals.EgmSignals)
			return _internal_mutable_egmsignals();
		}
