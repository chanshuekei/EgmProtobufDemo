...
const uint32_t TableStruct_egm_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::abb::egm::EgmTestSignals, _impl_.egmsignals_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 174, -1, -1, sizeof(::abb::egm::EgmMeasuredForce)},
  { 181, 196, -1, sizeof(::abb::egm::EgmRobot)},
  { 205, 214, -1, sizeof(::abb::egm::EgmSensor)},
  { 217, 225, -1, sizeof(::abb::egm::EgmSensorPathCorr)},
};
...
const char descriptor_table_protodef_egm_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "NG\020\002\"$\n\016EgmTestSignals\022\022\n\nEgmSignals\030\001 \003"
  "(\001\"!\n\020EgmMeasuredForce\022\r\n\005force\030\001 \003(\001\"\203\003"
  "\n\010EgmRobot\022\"\n\006header\030\001 \001(\0132\022.abb.egm.Egm"
  "Header\022&\n\010feedBack\030\002 \001(\0132\024.abb.egm.EgmFe"
  "edBack\022$\n\007planned\030\003 \001(\0132\023.abb.egm.EgmPla"
  "nned\022*\n\nmotorState\030\004 \001(\0132\026.abb.egm.EgmMo"
  "torState\022&\n\010mciState\030\005 \001(\0132\024.abb.egm.Egm"
  "MCIState\022\031\n\021mciConvergenceMet\030\006 \001(\010\022,\n\013t"
  "estSignals\030\007 \001(\0132\027.abb.egm.EgmTestSignal"
  "s\0226\n\016rapidExecState\030\010 \001(\0132\036.abb.egm.EgmR"
  "apidCtrlExecState\0220\n\rmeasuredForce\030\t \001(\013"
  "2\031.abb.egm.EgmMeasuredForce\"}\n\tEgmSensor"
  "\022\"\n\006header\030\001 \001(\0132\022.abb.egm.EgmHeader\022$\n\007"
  "planned\030\002 \001(\0132\023.abb.egm.EgmPlanned\022&\n\010sp"
  "eedRef\030\003 \001(\0132\024.abb.egm.EgmSpeedRef\"_\n\021Eg"
  "mSensorPathCorr\022\"\n\006header\030\001 \001(\0132\022.abb.eg"
  "m.EgmHeader\022&\n\010pathCorr\030\002 \001(\0132\024.abb.egm."
  "EgmPathCorr"
  ;
static ::_pbi::once_flag descriptor_table_egm_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_egm_2eproto = {
    false, false, 2411, descriptor_table_protodef_egm_2eproto,
    "egm.proto",
    &descriptor_table_egm_2eproto_once, nullptr, 0, 21,
...
EgmTestSignals::EgmTestSignals(const EgmTestSignals& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.egmsignals_){from._impl_.egmsignals_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void EgmTestSignals::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.egmsignals_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void EgmTestSignals::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.egmsignals_.~RepeatedField();
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // repeated double EgmSignals = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 9)) {
          ptr -= 1;
          do {
            ptr += 1;
            _internal_add_egmsignals(::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr));
            ptr += sizeof(double);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<9>(ptr));
        } else if (static_cast<uint8_t>(tag) == 10) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedDoubleParser(_internal_mutable_egmsignals(), ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* EgmTestSignals::_InternalSerialize(
  ...
  // repeated double EgmSignals = 1;
  for (int i = 0, n = this->_internal_egmsignals_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(1, this->_internal_egmsignals(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:abb.egm.EgmTestSignals)
  ...
  // repeated double EgmSignals = 1;
  {
    unsigned int count = static_cast<unsigned int>(this->_internal_egmsignals_size());
    size_t data_size = 8UL * count;
    total_size += 1 *
                  ::_pbi::FromIntSize(this->_internal_egmsignals_size());
    total_size += data_size;
  }
...
void EgmTestSignals::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.egmsignals_.MergeFrom(from._impl_.egmsignals_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void EgmTestSignals::InternalSwap(EgmTestSignals* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.egmsignals_.InternalSwap(&other->_impl_.egmsignals_);
}
...
uint8_t* EgmMeasuredForce::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_force_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(1, this->_internal_force(i), target);
  }
...
void EgmRobot::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_mciconvergencemet(from._internal_mciconvergencemet());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
